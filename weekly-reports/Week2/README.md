...
Weekly reports for the **RBC Stress Scenario Generator**, formatted for the team site
...
## Publish to columbiarisk.github.io
...
1. Copy `week2_report.html` into the site's `weekly-reports/` directory.
